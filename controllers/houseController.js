...
exports.getHouseData = async (req, res) => {
    try {
        ...
        // Step 1: Check if house already exists
        ...
        // Step 4: Increment AirDNA API counter
        ...
        // Handle no comparable data error specifically
        if (error.message === "NO_COMP_DATA") {
            return res.status(404).json({ 
                error: "No comparable data available",
                message: "Sorry, we don't have rental data available for this address. This could be because the address is too new, in a remote area, or there aren't enough comparable rental properties nearby."
            });
        }
